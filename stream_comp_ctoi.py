...
tfop_disp = []
tic_id = []
with open('/home/rmorris/documents/exofop_tess_ctois.csv', 'r') as file:
    ...
    for row in reader:
        tic_id.append(row[0])
        ra_toi.append(row[14])
        dec_toi.append(row[15])
        tess_mag.append(row[12])
        tfop_disp.append(row[10])
...
file = open('/home/rmorris/documents/stream_ctoi.txt', "a") 
