...
equivwidth = []
ew_err = []
with open('/home/user/documents/spectra_ew_YYMMDD/spectra_ew_{}.txt'.format(date), 'r') as file:
...
class galah_target:
    ...
    def plotting(self):
        ...
        #plt.show()
        plt.savefig('/data/storage/GALAH/EW_ratios/{}.png'.format(self.gaia))
        plt.close()    
        
    def writeout(self):
        ### problem with writeout since all have dif EW1/3 lengths
        file = open('/home/user/documents/ew_outliers.txt', "a")
