...
def get_cbvs(sector,camera,chip,time):
        ...
        ----------
        """
        #print('/data/storage/.eleanor/metadata/s{0:04d}/cbv_components_s{0:04d}_{1:04d}_{2:04d}.txt'.format(int(sector),int(sector),int(camera),int(chip)))
        #matrix_file = np.loadtxt('/data/storage/.eleanor/metadata/s{0:04d}/cbv_components_s{0:04d}_{1:04d}_{2:04d}.txt'.format(int(sector),int(camera),int(chip)))
        try:
            #print('Trying CBVs')
            matrix_file = np.loadtxt('/home/user/.eleanor/metadata/s{0:04d}/cbv_components_s{0:04d}_{1:04d}_{2:04d}.txt'.format(int(sector),int(camera),int(chip)))
