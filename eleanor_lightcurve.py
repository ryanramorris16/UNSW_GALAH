...
tic_period = []
tic_period_error = []
with open('/home/user/downloads/exofop_tess_tois_faint_no_FP.txt', 'r') as file:
	...
	###first try to find 2-min data for this sector
			try:
				...
				try:
					...
					flux = []
					background = []
					data = fits.open('/data/storage/GALAH/all_target_lc/{}_s{}_eleanor_data.fits'.format(i,sector))
					...
					try:
						...
						datum.save(output_fn='{}_s{}_eleanor_data.fits'.format(i,sector),directory='/data/storage/GALAH/all_target_lc/')
...
=======
	...
	try:
		if end_ind-beg_ind > 10000:
			if j % 10000 == 0:
				with open('/home/user/documents/lc_progress/eleanor_tls_periods_0-{}.txt'.format(j), 'w') as file:
...
with open('/home/user/documents/project/tls_bkg_periods_small_sigma.txt', 'w') as file:
...
with open('/home/user/documents/eleanor_tls_periods_{}-{}.txt'.format(beg_ind, end_ind), 'w') as file:
...
#plt.ylabel('TLS Period')
#plt.title('Published vs Calculated Period')
#plt.savefig('/home/user/documents/eleanor_tls_per_plot.png')
>>>>>>> 16c1090c6bad8b5863f3e8b6888f01b5300804f7
