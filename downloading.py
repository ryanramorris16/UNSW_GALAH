...
for j, i in enumerate(galah_date_18[10:11]):
    os.system("wget --user USERNAME --password 'PASSWORD' -P /data/storage/GALAH/Simult_GALAH_Data/ https://cloud.datacentral.org.au/remote.php/webdav/GALAH/obs/reductions/Iraf_6.0/{}/spectra/all/all.tar.gz".format(i))
    os.system("tar -xvzf /data/storage/GALAH/Simult_GALAH_Data/all.tar.gz -C /data/storage/GALAH/Simult_GALAH_Data/") # have to be in same folder as above?
    os.system("rm /data/storage/GALAH/Simult_GALAH_Data/all.tar.gz")       # same as above^
    os.system("wget --user USERNAME --password 'PASSWORD' -P /data/storage/GALAH/Simult_GALAH_Data/ https://cloud.datacentral.org.au/remote.php/webdav/GALAH/obs/reductions/Iraf_6.0/{}/spectra/com/com.tar.gz".format(i))
    os.system("tar -xvzf /data/storage/GALAH/Simult_GALAH_Data/com.tar.gz -C /data/storage/GALAH/Simult_GALAH_Data/") # have to be in same folder as above?
    os.system("rm /data/storage/GALAH/Simult_GALAH_Data/com.tar.gz")       # same as above^
    print(j)

#link = 'https://cloud.datacentral.org.au/remote.php/webdav/GALAH/public/GALAH_DR3/GALAH_DR3_main_allspec_v2.fits'
#os.system("wget --user USERNAME --password 'PASSWORD' /home/user/documents/ {}".format(link))
