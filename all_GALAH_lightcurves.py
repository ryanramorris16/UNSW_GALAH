...
for j,i in enumerate(mass_id[0:2]):#[beg_ind:end_ind]):
    ...
    ###first try to find 2-min data for this sector
            try:
                data = fits.open('/data/storage/GALAH/lightkurve/{}_s{}.fits'.format(TIC,sector))
                ...
                try:
                    ...
                    lc.to_fits(path='/data/storage/GALAH/lightkurve/{}_s{}.fits'.format(TIC,sector), overwrite=True)
                    ...
                    try:
                        ...
                        try:
                            ...
                            datum.save(output_fn='{}_s{}.fits'.format(TIC,sector),directory='/data/storage/GALAH/eleanor/')
