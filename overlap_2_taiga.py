...
for index,ids in enumerate(target_id):
	if target_sector[index] <= 31:
		...
		try:
			...
			plt.savefig('/data/wallaby/rmorris/GALAH/Simult_Plots_Ratios/Bin_{}/{}/{}_lc_sector_{}_{}.png'.format(binner,data_source[index], ids, target_sector[index], data_source[index]))
