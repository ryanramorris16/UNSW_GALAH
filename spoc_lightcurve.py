...
tic_ra = []
tic_dec =[]
with open('/home/user/documents/exofop_tess_tois_faint_no_FP.txt', 'r') as file:
...
for j,i in enumerate(tic_ids):
	try:
		...
		#print(product_list)
		download_data = Observations.download_products(product_list,extension="lc.fits",download_dir="/data/storage/SPOC/{}".format(tic_ids[j]))
...
with open('/home/user/documents/spoc_periods.txt', 'w') as file:
...
plt.savefig('/home/user/documents/spoc_per_comparison.png')
