    ...
    ###first try to find 2-min data for this sector
                try:
                    ...
                    try:
                        ...
                        try:
                            data = fits.open('/data/storage/GALAH/eleanor/{}_s{}.fits'.format(TIC,sector)) #have to change for katana storage
                            source='eleanor'
                ...
                try:                
                    if os.path.isfile('/data/storage/GALAH/{}/{}_s{}.fits'.format(source,TIC,sector)):    
