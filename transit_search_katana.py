...
class transit:
    ...
    parameters:
        ...
        directory: directory where folders of light curves are stored, separated by source (eleanor vs lightkurve) (/data/storage/GALAH/)
    ...
    def writeout(self):
        ...
        totalfile = open('/home/user/targets_plotted.txt',"a")
        ...
        totalfile.close()    
        '''
        writeout_specific = open('/home/user/394584021_data.txt',"a")
    ...
    def check_done(self):
        ...
        done_id = []
        sdes = []
        with open('/home/user/targets_plotted.txt','r') as file:
